    ...
    Config Diff P0m5xej
    ===================
    Developer-friendly CLI that helps you inspect projects in seconds.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly CLI that helps you inspect projects in seconds.")
